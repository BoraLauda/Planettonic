    ...
    public class IceBreaker : MonoBehaviour
    {
        ...
        public List<DialogueDataları> ioGoodQuestions;
        public List<DialogueDataları> ioMidQuestions;
        public List<DialogueDataları> ioBadQuestions;
        
        public List<DialogueDataları> elroiGoodQuestions;
        public List<DialogueDataları> elroiMidQuestions;
        public List<DialogueDataları> elroiBadQuestions;
        ...
        void CheckHit()
        {
            ...
            TargetCharacter currentTarget = isIoTurn ? TargetCharacter.Io : TargetCharacter.Elroi;
            ...
            if (ZoneDetect(currentY, zoneYellow))
            {
                ...
                selectedDialogue = GetRandomQuestion(isIoTurn ? ioGoodQuestions : elroiGoodQuestions);
            }
            ...
            else if (ZoneDetect(currentY, zonePink) || ZoneDetect(currentY, zonePink1))
            {
                ...
                selectedDialogue = GetRandomQuestion(isIoTurn ? ioMidQuestions : elroiMidQuestions);
            }
            ...
            else
            {
                ...
                selectedDialogue = GetRandomQuestion(isIoTurn ? ioBadQuestions : elroiBadQuestions);
            }
